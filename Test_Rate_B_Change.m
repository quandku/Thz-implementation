...
Rate1 = zeros(Sysparam.K,length(B)); % ideal Analog precoder
Rate2 = zeros(Sysparam.K,length(B)); % joint TTD and PS 
Rate3 = zeros(Sysparam.K,length(B)); % fixed PS 
Rate4 = zeros(Sysparam.K,length(B)); % Dynamic subarray
